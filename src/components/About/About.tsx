    ...
    <section className="about-section">
      ...
      <div className="about">
        ...
        <div className="about-text">
          <p>Before software, I was a pelvic health specialized doctor of physical therapy and small business owner, providing evidenced-based and trauma-informed care to patients of all ages, abilities, and backgrounds. </p>
