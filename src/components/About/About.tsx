    ...
    <section className="about-section">
      ...
      <div className="about">
        ...
        <div className="about-text">
          ...
          <p>The problem-solving, collaboration, and creativity that programming offers perfectly parallels my doctoral experience, and I quickly fell in love with engineering. I'm so excited about the next chapter.</p>
