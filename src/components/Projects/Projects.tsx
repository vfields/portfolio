    ...
    <section className="projects-section">
      ...
      <article className="project">
        ...
        <div className="project-text">
          ...
          <p className="tech-list">TypeScript, React, React Hooks, HTML/JSX, Cypress, CSS, Git, Accessibility, Responsive Design, Webpack</p>
      ...
      <article className="project">
        ...
        <div className="project-text">
          <h4>Group | 14 days</h4>
          <p className="description">This accessible application was built on a fullstack team of 7 engineers—3 FE, 4 BE—featuring GitHub's issue ticketing system and CI/CD. It allows any user to search for local restaurants, markets, and breweries, and a logged in user to store and delete their favorites!</p>
          <p className="tech-list">GraphQL, CircleCI, React, React Hooks, JavaScript, HTML/JSX, Cypress, CSS, Git, Accessibility, Webpack</p>
      ...
      <article className="project">
        ...
        <div className="project-text">
          ...
          <p className="tech-list">React, React Router, JavaScript, HTML/JSX, Cypress, CSS, RESTful APIs, Git, Accessibility, Webpack</p>
