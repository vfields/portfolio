  ...
  return (
    <section className="home">
      <div className="intro-container">
        ...
        <div className="intro">Nice to meet you! I'm currently seeking a position—feel free to check out my <a href="/projects">projects</a>, <a href="https://drive.google.com/file/d/1O-7xyTMAJUeofuPjoDTCWg33GCu5KFL_/view?usp=sharing" target='_blank' rel="noreferrer">resume</a>, or <a href="/contact">contact me</a> if you'd like to get in touch.</div>
      </div>
